...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Where would you like to start?"><p><span id="null">ជ្រើសរើសទីតាំងចាប់ផ្តើម?</span></p></div>')
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Choose a apartment"><p><span id="null">ជ្រើសរើសបន្ទប់ស្នាក់នៅរបស់អ្នក</span></p></div>')
